...
public class BookingView extends Layout {
    ...
    private JLabel lbl_musteri_name;
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        this.fld_book_idno.setText("312312312");
        this.fld_book_mail.setText("test@patika.com");
        this.fld_book_mpno.setText("12312321321");
        this.fld_book_prc.setText("2359");
        ...
        btn_book_save.addActionListener(e -> {
            ...
            if(Helper.isFieldListEmpty(checkFieldList)){
                ...
                book.setPrc(Integer.parseInt(fld_book_prc.getText()));
