...
public class CarView extends  Layout {
    ...
    private JLabel fld_welcome_car;
    ...
    public CarView(Car car){
        ...
        this.btn_car_save.addActionListener(e -> {
            if(Helper.isFieldListEmpty(new JTextField[]{fld_km_car,fld_car_plate})){
                Helper.showMssg("fill");
            }else{
                boolean result;
                ComboItem selectedModel = (ComboItem) this.cmb_car_brand.getSelectedItem();
